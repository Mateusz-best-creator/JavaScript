  ...
  const SingleProjetcsInDetails = [
    {
      ...
      technologiesExplanation: [
        "React Router is used to create a seamless and dynamic user interface, allowing users to navigate through the app's different pages and components with ease. Firebase provides a backend infrastructure for the app, enabling features such as user authentication and data storage. Users data is stored inside firebase firestore database.",
    ...
    },
    {
      ...
      technologiesExplanation: [
        ...
        "Firebase: Firebase is a Backend-as-a-Service (BaaS) platform that provides developers with a range of tools and services for building scalable and secure mobile and web applications. In the MealsToGo app, Firebase is used for user authentication. Users data is stored inside firebase firestore database.",
